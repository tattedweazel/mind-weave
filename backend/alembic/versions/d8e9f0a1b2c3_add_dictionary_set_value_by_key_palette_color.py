"""Add dictionary_set_value_by_key to palette colors
...
Summary:
  - Add dictionary_set_value_by_key key to existing palettes' colors JSON
"""
...
NEW_COLOR = {"dictionary_set_value_by_key": "#7c3aed"}
