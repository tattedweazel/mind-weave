"""Add workflow and simple_llm_call to palette colors
...
Summary:
  - Add workflow and simple_llm_call keys to existing palettes' colors JSON
  - Default palette and user palettes get the new keys with default hex values
"""
...
NEW_COLORS = {"workflow": "#14b8a6", "simple_llm_call": "#8b5cf6"}
