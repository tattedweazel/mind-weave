...
export const PALETTE_KEY_TO_FAMILY: Partial<Record<string, WorkflowPaletteFamily>> = {
    ...
    sandbox_force_simulation_pause: 'utility',
    sandbox_get_cell_items: 'utility',
    sandbox_remove_item_at_cell: 'utility',
    sandbox_spawn_item_at_cell: 'utility',
    sandbox_region: 'primitive',
    add_to_list: 'utility',
    add_ints: 'utility',
    add_days: 'utility',
...
export const WORKFLOW_PALETTE_COLORS: Record<string, string> = {
    ...
    gmail: '#f97316',
    sandbox_tick: '#2dd4bf',
    sandbox_region: '#2dd4bf',
    sandbox_get_position: '#14b8a6',
    sandbox_get_facing: '#0d9488',
    sandbox_get_nearby: '#5eead4',
    sandbox_move_forward: '#059669',
    sandbox_turn_left: '#10b981',
    sandbox_turn_right: '#10b981',
    sandbox_idle: '#34d399',
    sandbox_pick_up_item: '#fbbf24',
    sandbox_place_item: '#fb923c',
    sandbox_get_inventory: '#a78bfa',
    sandbox_prompt_user_action: '#6366f1',
    sandbox_force_simulation_pause: '#6366f1',
    sandbox_get_cell_items: '#c084fc',
    sandbox_remove_item_at_cell: '#e879f9',
    sandbox_spawn_item_at_cell: '#d946ef',
