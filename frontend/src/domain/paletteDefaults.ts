...
export const WORKFLOW_PALETTE_COLORS: Record<string, string> = {
    ...
    sandbox_get_inventory: '#14b8a6',
    sandbox_prompt_user_action: '#34d399',
    sandbox_force_simulation_pause: '#059669',
    sandbox_get_cell_items: '#5eead4',
    sandbox_remove_item_at_cell: '#fb923c',
    sandbox_spawn_item_at_cell: '#fbbf24',
