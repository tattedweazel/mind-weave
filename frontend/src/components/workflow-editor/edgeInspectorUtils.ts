...
const FLOW_TYPE_LABELS: Record<string, string> = {
    ...
    sandboxForceSimulationPause: 'Force Simulation Pause',
    sandboxGetCellItems: 'Get cell items',
    sandboxRemoveItemAtCell: 'Remove item',
    sandboxSpawnItemAtCell: 'Spawn item',
