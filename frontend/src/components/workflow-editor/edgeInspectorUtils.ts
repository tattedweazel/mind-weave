...
const FLOW_TYPE_LABELS: Record<string, string> = {
    ...
    sandboxTickPrimitive: 'Sandbox tick',
    listPrimitive: 'List',
    ...
    sandboxTickItems: 'Sandbox get items',
    sandboxWorldGrid: 'Sandbox world grid',
    sandboxAvailableCells: 'Sandbox available cells',
    sandboxTickPet: 'Sandbox tick pet',
    sandboxFilterItemsByType: 'Sandbox filter items',
    sandboxNearestItemByType: 'Sandbox nearest item by type',
    sandboxClosestItem: 'Get Closest Item',
    sandboxDecisionIntent: 'Sandbox decision intent',
    sandboxDecisionMoveTo: 'Sandbox decision move_to',
    sandboxStarterDecision: 'Starter sandbox decision',
    sandboxPetHunger: 'Sandbox pet hunger',
    sandboxPetEnergy: 'Sandbox pet energy',
    sandboxPetCell: 'Sandbox pet cell',
    sandboxIsNearby8: 'Sandbox is nearby8',
    sandboxFirstNearbyFood: 'Sandbox first nearby food',
    sandboxFirstFoodWorldOrder: 'Sandbox first food (world order)',
