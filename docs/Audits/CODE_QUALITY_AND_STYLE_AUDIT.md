...
## last_reviewed: 2026-03-19 (CQ-004, 006, 009, 010, 012 remediated; backlog clear)
...
*No open rows — add **CQ-013** on the next review pass when new issues are found.*
...
- **Mechanical Python consistency:** Ruff in [`backend/pyproject.toml`](../../backend/pyproject.toml) for `app/` and `tests/`.
